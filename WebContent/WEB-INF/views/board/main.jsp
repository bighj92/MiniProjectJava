				...
				<table class="table table-hover" id='board_list'>
					<thead>
						<tr>
							...
							<th class="w-50">제 목</th>
							<th class="text-center d-none d-md-table-cell">작성자</th>
							<th class="text-center d-none d-md-table-cell">작성일시</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var='obj' items="${contentList }">
							<tr>
								...
								<td><a
								href='${root }board/read?board_info_idx=${board_info_idx}&content_idx=${obj.content_idx}&page=${page}'>${obj.content_subject }
								</a></td>
