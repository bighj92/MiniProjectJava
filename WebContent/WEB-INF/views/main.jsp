					...
					<table class="table table-hover" id='board_list'>
						<thead>
							<tr>
								...
								<th>제 목</th>
								<th class="text-center w-25 d-none d-xl-table-cell">작성일시</th>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<th><a href='${root }board/read?board_info_idx=${board_list[idx.index].board_info_idx }
									   &content_idx=${obj.content_idx}&page=1'>${obj.content_subject }</a></th>
